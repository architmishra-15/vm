...
int main(void)
{
    ...
    mem_w16(cpu, addr, make_instr(OP_ADD, R0, R1));       // R0 = R0 + R1
    addr += 2;
    ...
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 511 + 511 = 1022
    addr += 2;
    
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 1022 + 511 = 1533
    addr += 2;
    
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 1533 + 511 = 2044
    addr += 2;
    
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 2044 + 511 = 2555
    addr += 2;
    
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 2555 + 511 = 3066
    addr += 2;
    
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 3066 + 511 = 3577
    addr += 2;
    
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R5));         // R3 = 3577 + 511 = 4088
    addr += 2;
    ...
    mem_w16(cpu, addr, make_instr(OP_ADD, R3, R4));         // R3 = 32767 + 1
    addr += 2;
